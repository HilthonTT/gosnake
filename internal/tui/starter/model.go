...
func NewInput(mode tui.Mode, db *sql.DB, cfg *config.Config, switchIn tui.SwitchModeInput) *Input {
	return &Input{
		mode:     mode,
		db:       db,
		cfg:      cfg,
